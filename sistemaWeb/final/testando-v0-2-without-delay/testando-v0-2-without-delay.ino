...
//int valor = 0;        // Número de ciclos restantes
//int angle = 0;        // Ângulo calculado
//int modoGlobal = 0;   // Modo atual
//enum TimerState { IDLE, FIRST_TIMER, SECOND_TIMER }; // Estados do temporizador
//TimerState currentState = IDLE;
//
//// Função de configuração inicial para endurance
//void endurance(int valorInicial, int nivelInicial) {
//    valor = valorInicial; // Configura o número de ciclos
//    angle = nivelPressao(nivelInicial); // Calcula o ângulo inicial
//    modoGlobal = 2; // Define o modo como endurance
////    Serial.printf("Configuração inicial: Modo Endurance, Valor: %d, Nível: %d\n", valor, nivelInicial);
//}
//
//// Função principal de controle do motor (já fornecida)
//void endurance() {
...
//            timerStart = currentTime; // Inicia o primeiro temporizador
//            currentState = FIRST_TIMER;
//            break;
//
//        case FIRST_TIMER:
//            // Verifica se o tempo do primeiro temporizador expirou
//            if (currentTime - timerStart >= primeiroTempo) {
//                moveMotorsToAngle(0); // Retorna ao nível 0
//                timerStart = currentTime; // Inicia o segundo temporizador
//                currentState = SECOND_TIMER;
//            }
//            break;
//
//        case SECOND_TIMER:
//            // Verifica se o tempo do segundo temporizador expirou
//            if (currentTime - timerStart >= segundoTempo) {
//                valor--; // Reduz o número de ciclos restantes
//                if (valor > 0) {
//                    moveMotorsToAngle(angle); // Move novamente ao ângulo inicial
//                    timerStart = currentTime; // Reinicia o primeiro temporizador
//                    currentState = FIRST_TIMER;
//                } else {
//                    currentState = IDLE; // Conclui a operação
...
int repetitionContrctTime = 4000;
int repetitionRealeaseTime = 10000;
